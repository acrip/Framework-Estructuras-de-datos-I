...
//                #region Metodo para insertar un elemento cuando existe mas de un elemento en la coleccion
//
//                
//                if (atrLongitud > 1)
//                {
...
//
//
//                    #region Metodo para insertar un elemento cuando solo existe un elemento en la coleccion
//                if (atrLongitud == 1)
//                {
//                    if(prmIndice == 0)
//                    {
...
//                    else
//                    {
//                        atrNodoPrimero.ponerSiguiente(varNodoNuevo);
//                        atrNodoUltimo = varNodoNuevo;
//                    }
//                    atrLongitud++;
//                    return true;
